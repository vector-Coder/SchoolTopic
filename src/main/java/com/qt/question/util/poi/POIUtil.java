package com.qt.question.util.poi;
...
public interface POIUtil {
     ...
     * @return List<List<Object>>
     */
    List<List<Object>> getExcelLinePartData(File excelFile,String sheetName,int startIndex,int endIndex) throws IOException, InvalidFormatException;
